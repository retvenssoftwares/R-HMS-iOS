...
class DashboradVC: UIViewController, ChartViewDelegate {
    ...
    // MARK: - Outlet
    @IBOutlet weak var constTrailingSideView: NSLayoutConstraint!
    @IBOutlet weak var constLeadingSideView: NSLayoutConstraint!
    ...
    var months: [String]!
    var arrSideMenuText = ["Dashboard", "Rates And Inventory", "Create Reservation", "Channel & Maping", "Booking", "Reports & Logs"]
    var arrSidemMenuLogo = ["DashboardImg","Tabbar2","DashboardImg", "Tabbar4","DashboardImg", "DashboardImg"]
    
    // MARK: - Lifecycle
    override func viewDidLoad() {
        super.viewDidLoad()
       
        sideMenuCollectionView.collectionViewLayout = createLayout()
...
//        viewSideMneu.isHidden = true
        ...
        let _: [Double] = [11011011111110, 8011100, 7111500, 3111300, 1411000, 15000, 6000, 1000, 18000, 19000, 20000, 21000]
...
//    }
    ...
    func animateSideMenu() {
            UIView.animate(withDuration: 0.3) {
                self.viewSideMenu.frame.origin.x = self.isSideMenuOpen ? 0 : -self.sideMenuWidth
            }
        }
...
extension DashboradVC:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! SideMenuCollectionCell
        cell.imgDashBoard.image = UIImage(named: arrSidemMenuLogo[indexPath.row])
        cell.lblDashBoard.text = arrSideMenuText[indexPath.row]
        return cell
    }
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let selectedIndexPath = collectionView.indexPathsForSelectedItems?.first {
                ...
                if let cell = collectionView.cellForItem(at: selectedIndexPath) as? SideMenuCollectionCell {
            ...
            if let cell = collectionView.cellForItem(at: indexPath) as? SideMenuCollectionCell {
